<template>
  <el-upload class="upload" drag action="http://upload.qiniup.com" :on-success='handleAvatarSuccess' :on-error="handleError"
    :before-upload="beforeAvatarUpload" :data="postData" multiple>
